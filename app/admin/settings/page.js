  ...
  async function loadSettings() {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setHeader({
          logoText: s.header_logo_text || 'Nha Khoa Smile',
                ...
                <div className="adm-card-body" style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                  <div className="adm-form-group">
                    ...
                    <input
                      ...
                      placeholder="e.g. Nha Khoa Smile"
                    />
                  </div>
                ...
                <div className="adm-card-body" style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                  <div className="adm-form-group">
                    ...
                    <input
                      ...
                      placeholder="e.g. © 2026 Nha Khoa Smile. All rights reserved."
                    />
                  </div>
