...
export async function generateMetadata({ params }) {
  ...
  if (!decoded) return { title: 'Asset Not Found | Nha Khoa Smile' };
  ...
  if (!file || file.is_public === 0) {
    return { title: 'Asset Restricted | Nha Khoa Smile' };
  }

  return {
    title: `Download: ${file.name} | Nha Khoa Smile`,
    description: file.description || `Download asset ${file.name} securely from Nha Khoa Smile.`
  };
}
