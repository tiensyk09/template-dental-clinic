...
function RegisterPageContent() {
  ...
  return (
    <div style={{
      ...
      position: 'relative',
      overflow: 'hidden',
      background: 'linear-gradient(135deg, #0c3061 0%, #0c3061 40%, #1a6fc4 70%, #1a3a1a 100%)'
    }}>
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '28px' }}>
          ...
          <h1 style={{ fontSize: '22px', fontWeight: 900, color: '#0c3061', margin: '0 0 4px 0', letterSpacing: '-0.02em' }}>
            Đăng Ký Thành Viên
          </h1>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '14px' }} autoComplete="off">
          ...
          <button
            ...
            style={{
              ...
              padding: '12px',
              marginTop: '8px',
              background: loading ? '#6b7280' : 'linear-gradient(135deg, #1a6fc4 0%, #155d9e 100%)',
              border: 'none',
              borderRadius: '12px',
              color: '#ffffff',
              fontWeight: 800,
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '24px' }} className="login-back">
          ...
          <Link 
            ...
            style={{ fontSize: '13px', color: '#1a6fc4', fontWeight: 600, textDecoration: 'none' }}
          >
            Đã có tài khoản? →
          </Link>
        </div>
