...
export default function ContactPage() {
  ...
  return (
    <div style={{ backgroundColor: '#f7fafd', minHeight: '100vh', padding: '40px 0' }}>
      <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 20px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '24px', fontSize: '13px', color: '#6b7280' }}>
          ...
          <span>/</span>
          <span style={{ color: '#1a6fc4', fontWeight: 600 }}>Liên hệ</span>
        </div>

        {/* Page Header */}
        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
          <h1 style={{ fontSize: '32px', fontWeight: 800, color: '#0c3061', marginBottom: '12px', letterSpacing: '-0.02em' }}>
            Liên Hệ Với Chúng Tôi
          </h1>
          <p style={{ color: '#4b5563', fontSize: '15px', maxWidth: '600px', margin: '0 auto', lineHeight: 1.6 }}>
            Nha Khoa Smile luôn sẵn sàng lắng nghe mọi thắc mắc và nhu cầu tư vấn nha khoa của quý khách. Hãy liên hệ với chúng tôi để được tư vấn chính gốc 100%.
          </p>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: '40px', alignItems: 'start' }} className="contact-grid">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            ...
            <div style={{ background: '#ffffff', borderRadius: '20px', padding: '32px', border: '1px solid #e5e7eb', boxShadow: '0 4px 20px rgba(0,0,0,0.02)', display: 'flex', flexDirection: 'column', gap: '24px' }}>
              ...
              <div style={{ display: 'flex', gap: '16px', alignItems: 'flex-start' }}>
                <div style={{ background: '#eaf3fb', color: '#1a6fc4', width: '48px', height: '48px', borderRadius: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '20px', flexShrink: 0 }}>
                  📍
                </div>
                <div>
                  <h4 style={{ fontSize: '16px', fontWeight: 700, color: '#0c3061', margin: '0 0 6px 0' }}>Trụ sở chính</h4>
                  <p style={{ fontSize: '14px', color: '#4b5563', lineHeight: 1.5, margin: 0 }}>45 Lê Lợi, Phường Bến Nghé, Quận 1, TP. Hồ Chí Minh</p>
                </div>
              </div>
              ...
              <div style={{ display: 'flex', gap: '16px', alignItems: 'flex-start' }}>
                ...
                <div>
                  <h4 style={{ fontSize: '16px', fontWeight: 700, color: '#0c3061', margin: '0 0 6px 0' }}>Hotline / Zalo đặt hàng</h4>
                  <a href="tel:0769442777" style={{ fontSize: '18px', fontWeight: 800, color: '#1a6fc4', textDecoration: 'none' }}>0769.442.777</a>
                </div>
              </div>
              ...
              <div style={{ display: 'flex', gap: '16px', alignItems: 'flex-start' }}>
                ...
                <div>
                  <h4 style={{ fontSize: '16px', fontWeight: 700, color: '#0c3061', margin: '0 0 6px 0' }}>Hòm thư điện tử</h4>
                  <p style={{ fontSize: '14px', color: '#4b5563', lineHeight: 1.5, margin: 0 }}>info@nhakhoasmile.vn</p>
                </div>
              </div>
              ...
              <div style={{ display: 'flex', gap: '16px', alignItems: 'flex-start' }}>
                ...
                <div>
                  <h4 style={{ fontSize: '16px', fontWeight: 700, color: '#0c3061', margin: '0 0 6px 0' }}>Trang thông tin điện tử</h4>
                  <p style={{ fontSize: '14px', color: '#4b5563', lineHeight: 1.5, margin: 0 }}>www.nhakhoasmile.vn</p>
                </div>
              </div>
            ...
            <div style={{ background: 'linear-gradient(135deg, #1a6fc4 0%, #0c3061 100%)', color: '#ffffff', borderRadius: '20px', padding: '28px', boxShadow: '0 4px 20px rgba(13, 104, 50, 0.1)' }}>
              <h4 style={{ fontSize: '15px', fontWeight: 800, margin: '0 0 8px 0', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Nha Khoa Smile</h4>
          ...
          <div style={{ background: '#ffffff', borderRadius: '20px', padding: '32px', border: '1px solid #e5e7eb', boxShadow: '0 4px 20px rgba(0,0,0,0.02)' }}>
            <h3 style={{ fontSize: '22px', fontWeight: 800, color: '#0c3061', marginBottom: '20px' }}>Gửi tin nhắn cho chúng tôi</h3>
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              <button
                ...
                disabled={submitting}
                style={{
                  background: submitting ? '#6b7280' : '#1a6fc4',
                  color: '#ffffff',
                  padding: '12px 24px',
                  borderRadius: '30px',
                  border: 'none',
